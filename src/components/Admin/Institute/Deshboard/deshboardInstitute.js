...
import {getEnrolledStudents,getReviews} from '../../../../redux/actions/institute/deshboard'
...
const InstituteDeshboard = props => {
    ...
    useEffect(()=>{
        getEnrolledStudents({institute_id: userID._id})
        getReviews({institute_id: userID._id})
        // getEnrolledStudents({institute_id: userID._id})
    },[])
