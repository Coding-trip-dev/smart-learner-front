...
import { getAllCourse } from '../../../../redux/actions/instructor/courseDetailsActionInstructor'
import { getAllSales } from '../../../../redux/actions/instructor/salesAction'
...
const ManageSales = props => {
  ...
  React.useEffect(() => {
    ...
    getAllCourse({ instructor_id: id })
    getAllSales({ instructor_id: "5e9d4a5eab438002fc7d97df" })
    // }
  }, [])
