...
const ViewCompletedOrder = props => {
    ...
    <div className="in-process-order-view-wrapper">
      <div className="row">
        <div className="col-12 completed-header">
          <img src={require('../assets/tickmark.png')} alt="" className="tick-mark-img" />
          {/* <CheckIcon style={{fontSize: '3em',fontWeight: '900',color: " white",position: 'relative',top:'0px',left:'-10px'}}/> */}
          Order Completed <span className="you-earn">You earned aed {order ? order.price : null}</span>
        </div>
      </div>
      <div className="row">
        <div className="col-2">
      ...
      <div className="row order-heading-wrapper">
        ...
        <div className="col-5">
          <span className="deliverd-on">
            Delivered on <span className="delivery-date">{order ? <>
...
export default withRouter(connect(mapStateToProps, { getViewdOrder })(ViewCompletedOrder))
