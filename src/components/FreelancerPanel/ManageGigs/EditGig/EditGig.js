...
import { getAllServices, updateService, getAllGigs } from "../../../../redux/actions/freelancer/servicesAction"
...
const EditService = props => {
  ...
  const { services, getAllServices, updateService, getAllGigs, gigs } = props
  ...
  useEffect(() => {
    ...
    if (gig) {
      setBasic(gig.packages[0].basic)
      setSilver(gig.packages[1].silver)
      setGolden(gig.packages[2].golden)
      setState(gig)
      setImages({
        ...images,
        image1: gig.images[0],
  ...
  return (
    <div className="offer-course-cntnr edit-service-cntnr ">
      <h3 className="heading _marginLeft">Edit Gig</h3>
        ...
        <div className="row mb-3">
          <div className="col-3 pr-2 dropdown-div offer-course-select-div _marginLeft">
            ...
            <select className="custom-select" onChange={onChangeHandler} name="service_id">
              ...
              {services.services !== null && services.services !== undefined ?
                services.services.map((item, key) => {
                  return <option value={item._id} key={key}
                    selected={gig ? item._id === gig.service_id ? true : false : false}
                  >{item.name_in_english}</option>
                })
                : null
              }
            </select>
            ...
            <select className="custom-select" onChange={onChangeHandler} name="service_category_id">
              ...
              {serviceCate !== null ?
                serviceCate.map((item, key) => {
                  return <option value={item._id} key={key}
                    selected={gig ? item._id === gig.service_category_id ? true : false : false}
                  ...
                  <tr>
                    ...
                    <td>
                      <select name="delivery_days"
                        ...
                        {revisions.map((item, key) => {
                          return <option value={item} key={key}
                            selected={basic ? item === basic.delivery_days ? true : false : false}
                          >{item} Days Delivery</option>
                        })}
                      </select>
                    </td>
                    <td>
                      <select id="" className="select-options"
                        ...
                        {revisions.map((item, key) => {
                          return <option value={item} key={key}
                            selected={silver ? item === silver.delivery_days ? true : false : false}
                          >{item} Days Delivery</option>
                        })}
                      </select>
                    </td>
                    <td>
                      <select name="delivery_days"
                        ...
                        {revisions.map((item, key) => {
                          return <option value={item} key={key}
                            selected={golden ? item === golden.delivery_days ? true : false : false}
                          >{item} Days Delivery</option>
                        })}
                      </select>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <select name="revision" onChange={basicChangeHandler} id="" className="select-options">
                        ...
                        {revisions.map((item, key) => {
                          return <option value={item} key={key}
                            selected={basic ? item === basic.revision ? true : false : false}
                          >{item}</option>
                        })}
                      </select>
                    </td>
                    <td>
                      <select name="revision"
                        ...
                        {revisions.map((item, key) => {
                          return <option value={item} key={key}
                            selected={silver ? item === silver.revision ? true : false : false}
                          >{item}</option>
                        })}
                      </select>
                    </td>
                      ...
                      <select name="revision" onChange={goldenChangeHandler} id="" className="select-options">
                        ...
                        {revisions.map((item, key) => {
                          return <option value={item} key={key}
                            ...
                            selected={golden ? item === golden.revision ? true : false : false}
                          >{item}</option>
                        })}
                      </select>
                    </td>
          ...
          <div className="row">
            <div className="col-4 pl-0">
              <label htmlFor="image1">
                <img
                  className="img-fluid"
                  src={`http://18.217.77.0:5000/uploads/${images.image1}`}
                  alt="img"
                  id="image1-1"
                />
            ...
            <div className="col-4 pl-2 pr-2">
              <label htmlFor="image2">
                <img
                  className="img-fluid"
                  src={`http://18.217.77.0:5000/uploads/${images.image2}`}
                  alt="img"
                  id="image2-2"
                />
              ...
              <label htmlFor="image3">
                <img
                  className="img-fluid"
                  src={`http://18.217.77.0:5000/uploads/${images.image3}`}
                  alt="img"
                  id="image3-3"
                />
...
let mapStateToProps = state => {
  return {
    services: state.FreelancerServices.services,
    gigs: state.FreelancerServices.gigs
  }
}
export default connect(mapStateToProps, { getAllServices, updateService, getAllGigs })(EditService);
