...
const StudentQueryTable = ({ headings, data, courses }) => {
  ...
  return (
    ...
    <>
      ...
      <table className="table table_course_management table-borderless table_new_order">
        <thead>
          <tr>
            {headings.map((h, i) => (
              <th key={i} scope="col">
                ...
                data.map((d, i) => (
                  <tr key={i}>
                    ...
                    <td className='running-orders'>
                        ...
                        <div className="name-outer" style={{top: 0}}>
                    ...
                    <td className="order-description">{d.service_tittle}</td>
