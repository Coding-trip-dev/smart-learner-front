...
export const getAllSales = (body) => { //Get all sales
    return dispatch => {
        ...
        axios.post(baseURL + "/api/instructor/withdraw/getsales", body)
            .then(resp => {
                if (resp) {
...
export const getWirhdrawlHistory = (body) => {
    return dispatch => {
        console.log(body);
        // user id to be sent in the body as instructor ="user id" 

        axios.post(baseURL + "/api/instructor/withdraw/withdrawhistory", body)
            .then(resp => {
                if (resp) {
                    // toast.success("Profile Successfully updated")
                    console.log(resp);
...
export const getBankDetail = (body) => {
    return dispatch => {
        ...
        axios.post(baseURL + "/api/instructor/withdraw/getaccount", body)
            .then(resp => {
                if (resp) {
                    // toast.success("Profile Successfully updated")
                    console.log(resp);
...
export const sendWithdrawRequest = (body) => {
    return dispatch => {
        ...
        axios.post(baseURL + "/api/instructor/withdraw/withdrawrequest", body)
            .then(resp => {
                if (resp) {
