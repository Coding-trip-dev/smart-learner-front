...
import {getAllChapter} from './chapterDetailsActionInstructor' 
...
export const addNewCourse = (body,user)=>{
    return dispatch =>{
        ...
        axios.post(baseURL + '/api/instructor/course/addcourse',formData, config)
        .then(resp => {
            console.log(resp);
        ...
        .catch(err => {
            toast.error("Internal Server Error, Try agian.")
        })
...
export const getAllCourse = (body,user)=>{
    ...
    return dispatch =>{
        ...
        // body = {"instructor_id": "5e9d4a5eab438002fc7d97df"} for demo 
        
        axios.post(baseURL + '/api/instructor/course/get_all',body)
        .then(resp => {
            // console.log(resp);
...
export const addNewChapter = (body)=>{
    ...
    console.log(body);
     ...
     return dispatch =>{
         ...
         axios.post(baseURL + '/api/instructor/chapter',body)
         .then(resp => {
             console.log(resp);
...
export const getAllDegreeCategory = ()=>{
    ...
    return dispatch =>{
        ...
        axios.get(baseURL + '/api/instructor/degree/get_all_degree_category')
        .then(resp => {
                console.log(resp);
...
export const getAllDegress = ()=>{
    ...
    return dispatch =>{
        ...
        axios.get(baseURL + '/api/instructor/degree/get_all',)
        .then(resp => {
            console.log(resp);
