...
export const getEnrolledStudents = (body) => {
    return dispatch => {
        ...
        axios.post(baseURL + `/api/institute/order/getenrolled`, body)
            .then(resp => {
                console.log(resp);
...
export const getReviews = (body) => {
    return dispatch => {
        ...
        axios.post(baseURL + `/api/institute/review/getallreview`, body)
            .then(resp => {
                console.log(resp);
...
export const getInstituteSale = (body) => {
    return dispatch => {
        ...
        axios.post(baseURL + `/api/institute/order/dashboard`, body)
            .then(resp => {
                console.log(resp);
